...
<template>
  <div class="flex h-full w-full items-center justify-center">
    <div class="card max-h-[90%] max-w-[60%] min-w-96 overflow-auto border-8 border-primary bg-base-100 shadow-md">
      <div class="card-body">
        <h2 class="card-title">Register</h2>
        <form @submit.prevent="register" class="grid grid-cols-2 lg:grid-cols-1 gap-4">
          ...
          <div class="col-span-2 lg:col-span-1 mt-6 text-error">
            {{ err }}
          </div>
